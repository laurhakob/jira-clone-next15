...
//   projectId?: Id<"projects"> | null;
//   onClose?: () => void;
//   task?: Task; // Replaced any with Task
// }
...
//   );
//   const [assignee, setAssignee] = useState<Id<"members"> | null>(
...
//     if (!name || !selectedProject || !status) {
//       alert(
//         "Please fill in all required fields: Task Name, Project, and Status"
//       );
//       return;
//     }
...
//         <div>
//           <label className="block text-sm font-medium mb-1">Assignee</label>
//           // Assignee Select (unchanged)
//           <Select
//             value={assignee || ""}
//             onValueChange={(value) =>
//               setAssignee(value ? (value as Id<"members">) : null)
//             }
//           >
//             <SelectTrigger className="w-full">
//               <SelectValue placeholder="Select assignee" />
...
//             onValueChange={(value) =>
//               setSelectedProject(value as Id<"projects">)
//             }
//           >
//             <SelectTrigger className="w-full">
//               <SelectValue placeholder="Select project" />
